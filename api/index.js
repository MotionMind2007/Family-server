...
module.exports = async (req, res) => {
  ...
  try {
    ...
    if (!tokens || !Array.isArray(tokens) || tokens.length === 0) {
      return res.status(400).json({ error: 'tokens array দিতে হবে (অন্তত ১টা device token)' });
    }
